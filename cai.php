...
if($_COOKIE["userty"]=="sno")
{
    ...
    $sql = 'INSERT INTO ktb (xno, zno,xty,zty) VALUES ("'.$_COOKIE["userno"].'",'.$_GET["zno"].',"'.$_COOKIE["userty"].'",2)';
    //echo $sql;
    ...
    if($result)
    {    
        $sql0 = 'UPDATE ztb SET endt = endt - 3*3600 where zno = '.$_GET["zno"];
    ...
    echo "<!DOCTYPE html><html><script>alert('匿名没有踩的权限')</script>";
}
