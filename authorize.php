...
<body>
	...
	*/
	...
	// VALUES ('%s', '%s',0)",("s".$row["yb_userid"]),substr($row["yb_userid"],3,7));
	$rawid=(string)$row["yb_userid"];
	...
	$sql = 'INSERT INTO stb (sno, snick,endt) VALUES ("s'.$newid.'", '.substr($row["yb_userid"],3,7).',0);';
	...
	$sql1 = 'select * from stb where sno ="s'.$newid.'"';
